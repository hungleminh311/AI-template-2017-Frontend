  ...
  return (
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden px-6 py-2.5 sm:px-3.5 sm:before:flex-1 bg-primary-400/[.1]">
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        ...
        <a href="#" className="flex-none rounded-full bg-primary-600 border-2 border-primary-950 shadow-neo-brutal text-white px-3.5 py-1 text-sm font-semibold hover:opacity-80">
          Register Now{" "}
